...
const Register = () => {
  return (
    /* Container uses 'h-screen' and 'overflow-hidden' to prevent 
      the whole page from moving/scrolling.
    */
    <div className="relative h-screen w-full flex items-center justify-center px-4 overflow-hidden">
      
      {/* 1. BACKGROUND (Fixed & Non-moving) */}
      ...
      {/* 3. MAIN CARD: Constrained height to prevent movement */}
      <div className="relative z-10 w-full max-w-5xl max-h-[90vh] flex flex-col md:flex-row bg-green-900/90 backdrop-blur-md rounded-[2rem] overflow-hidden shadow-2xl border border-white/10">
        ...
        {/* LEFT SIDE: Info (Hidden on small mobile if screen is too short) */}
        ...
        {/* RIGHT SIDE: Form (Scrolls internally if screen is tiny) */}
        <div className="flex-1 bg-white/10 backdrop-blur-2xl p-6 md:p-10 overflow-y-auto custom-scrollbar">
          ...
          <form className="flex flex-col gap-4">
            ...
            <p className="text-xs text-center text-white/70">
              ...
              <button type="button" className="font-bold text-green-300 hover:underline">
                Login
              </button>
            </p>
          </form>
