  ...
  return (
    ...
    <div className='relative h-screen w-full'>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-4">
            ...
            {/* Form Container */}
            <div className="bg-white/20 backdrop-blur-md rounded-xl p-8 w-full max-w-md">
                <h2 className="text-[#325D05] text-2xl font-semibold mb-6 text-center">
                    Login
                </h2>
                ...
                <form className="flex flex-col gap-4">
                    ...
                    <button
                        type="submit"
                        className="bg-[#325D05] hover:bg-[#417905] transition-colors text-white p-3 rounded-md mt-2"
                    >
                        Sign In
                    </button>

                    <p className="text-sm text-[#f9fdf5] text-center">
                        Forgot Password ?
                    </p>

                    <p className="text-sm text-[#f9fdf5] text-center">
                        Don't have an account ? <span className="text-[#1b3302] font-bold">Sign Up</span>
                    </p>
