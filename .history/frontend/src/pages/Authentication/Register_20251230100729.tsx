...
const Register = () => {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-x-hidden">
      {/* Background Image - Absolute for layout, but fixed to prevent scrolling issues */}
      ...
      {/* Logo - Positioned top left with better visibility */}
      <img
        src={WhiteLogo}
        alt="Logo"
        className="absolute top-6 left-6 w-32 sm:w-40 z-20 drop-shadow-lg"
      />
